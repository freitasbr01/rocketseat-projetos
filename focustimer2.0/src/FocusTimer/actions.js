...
// função play foi chamada indiretamente através do objeto actions
...
export function plus() {
  ...
  minutes += 5; // Adiciona 5 minutos
  el.minutes.textContent = String(minutes).padStart(2, "0"); // Atualiza o display
}
...
export function florest(event) {
  ...
  state.isMute = !state.isMute // Se state.isMute for true, ele se tornará false e vice-versa.
